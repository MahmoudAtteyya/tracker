      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 p-2 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20">
              <div className="flex-1 relative">
                ...
                <Input
                  ...
                  className="pl-12 pr-4 py-4 text-lg border-0 focus:ring-2 focus:ring-lavender-500 rounded-xl bg-transparent placeholder:text-muted-foreground/60 arabic"
                  disabled={isLoading}
                />
              </div>
              <Button
                ...
                size="lg"
                disabled={isLoading}
                className="bg-gradient-to-r from-lavender-600 to-lavender-700 hover:from-lavender-700 hover:to-lavender-800 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2"
              >
                {isLoading ? (
          ...
          <div className="mt-8 text-white/70">
            <p className="text-sm mb-2">Example tracking number:</p>
            <button
              onClick={() => setTrackingCode('ENO31557487EG')}
              className="text-white/90 hover:text-white underline underline-offset-4 transition-colors font-mono text-sm bg-white/10 px-3 py-1 rounded-lg"
            >
              ENO31557487EG
            </button>
          </div>
